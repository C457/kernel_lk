...
// if you modified anything in this file and enabled CONFIG_ARM_TRUSTZONE Feature.
...
#define SUPPORT_DISPLAY_MAX_WIDTH	1024
#define SUPPORT_DISPLAY_MAX_HEIGHT	600

#define FB_PRIMARY_WIDTH       		1024
#define FB_PRIMARY_HEIGHT       	600
...
#define SECURED_INBUFF_SIZE	(6*SZ_1MB)
...
#define OVERLAY1_SIZE		0//ARRAY_MBYTE(SUPPORT_DISPLAY_MAX_WIDTH * SUPPORT_DISPLAY_MAX_HEIGHT * 2 * VPU_BUFFER_MANAGE_COUNT) // Should fix it!!
...
#if defined(CONFIG_V4L2_VIDEO_INPUT_DRIVER)
...
//#########################################################################
#define VIQE_MEM_SIZE           (JPEG_HEADER_SIZE+JPEG_STREAM_SIZE+JPEG_RAW_SIZE)
...
#define V4L2_SUBTITLE_SIZE	(16*SZ_1MB)
#else
#define V4L2_VOUT_SIZE		(0)
#define V4L2_SUBTITLE_SIZE	(0)
#endif

#if defined(CONFIG_TCC_EARLY_CAMERA_SUPPORT)
#define EARLY_CAM_VIQE_SIZE     (4*SZ_1MB)     // 720*480
#else
#define EARLY_CAM_VIQE_SIZE     (0)
#endif


#if defined(CONFIG_TCC_EARLY_CAMERA_SUPPORT)
#define EARLY_CAM_VIEW_SIZE     (5 * SZ_1MB)
//#define EARLY_CAM_VIEW_SIZE 	(30 * SZ_1MB)
#else
#define EARLY_CAM_VIEW_SIZE     (0)
#endif
#if defined(CONFIG_TCC_EARLY_CAMERA_SUPPORT)
#define PARKING_GUIDE_SIZE      (5 * SZ_1MB)    // 1024x600 Single LCD Size 32bit color
#else
#define PARKING_GUIDE_SIZE      (0)
#endif


#if defined(DEFAULT_DISPLAY_HDMI) && defined(FLD0800)
#define FB_DUPLICATE_SIZE       (4 * SZ_1MB)
#else
...
#define EARLY_CAM_VIQE_BASE     (V4L2_SUBTITLE_BASE+V4L2_SUBTITLE_SIZE)
#define EARLY_CAM_VIEW_BASE     (EARLY_CAM_VIQE_BASE+EARLY_CAM_VIQE_SIZE)
#define PARKING_GUIDE_BASE      (EARLY_CAM_VIEW_BASE+EARLY_CAM_VIEW_SIZE)
#define FB_DUPLICATE_BASE       (PARKING_GUIDE_BASE + PARKING_GUIDE_SIZE)
#define PMAP_TOTAL		((FB_DUPLICATE_BASE-PMAP_BASE)+FB_DUPLICATE_SIZE)
