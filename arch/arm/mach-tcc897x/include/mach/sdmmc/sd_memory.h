...
typedef struct BOOTSD_Header_info {
	...
	unsigned long	ulNSKHeaderBase; // sector addr
#endif // TCC_NSK_ENABLE
#if defined(TCC_NSK_ENABLE)
	unsigned long   ulResv176[82];
#else
 ...
 * NAND BL1 TARGET			8 BYTE
 * CISCK PUB KEY1 START		8 Byte
 * CISCK PUB KEY1 SIZE		8 Byte
 * CM4 START				8 BYTE
 * CM4 SIZE					8 BYTE
 * CA7A START				8 BYTE
 * CA7A SIZE				8 BYTE
...
typedef struct BOOTSD_sHeader_info{
	...
	unsigned long long kcisco1_start;
	unsigned long long kcisco1_size;
	unsigned long long cm4_start;
	unsigned long long cm4_size;
	unsigned long long ca7in_start;
	unsigned long long ca7in_size;
	unsigned long long ca7ext_start;
	unsigned long long ca7ext_size;
    unsigned long long rev0_base;
	unsigned long long rev1_start;
	unsigned long long rev1_size;
	unsigned long long rev00_start;
	unsigned long long rev00_size;
	unsigned long long rev01_start;
	unsigned long long rev01_size;
    unsigned long long rev02;
    unsigned long long rev03;
	unsigned char rev2[284];
#else
