...
struct device_driver_ops {
	...
	int (*ReadSector)(int a, unsigned long b, unsigned long c, void *d);
	int (*WriteSector)(int a, unsigned long b, unsigned long c, void *d);
	int (*ReadMultiStart)(unsigned long a , unsigned long b );
	int (*ReadMultiSector)(int a , unsigned long b , unsigned long c, void * d);
	int (*ReadMultiStop)(void);
	int (*WriteMultiStart)(unsigned long a , unsigned long b);
	int (*WriteMultiSector)(int a , unsigned long b , unsigned long c, void * d);
	int (*WriteMultiStop)(void);
	unsigned long (*HDReadSector)(unsigned long a, unsigned short b , unsigned char * c);
	unsigned long (*HDWriteSector)(unsigned long a, unsigned short b, unsigned char * c);
	int (*HDClearSector)(unsigned long a, unsigned long b);
	int (*Ioctl)(int a, void * b);
};
