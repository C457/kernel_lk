...
static struct device_driver_ops EMMC_Disk = {
	.LockFlag		= DISK_DEVICE_UNLOCK,
	.DiskType		= DISK_DEVICE_TRIFLASH,
	.ReadSector		= &BOOTSD_Read,
	.WriteSector		= &BOOTSD_Write,
	.ReadMultiStart		= &BOOTSD_ReadMultiStart,
	.ReadMultiSector	= &BOOTSD_ReadMulti,
	.ReadMultiStop		= &BOOTSD_ReadMultiStop,
	.WriteMultiStart	= &BOOTSD_WriteMultiStart,
	.WriteMultiSector	= &BOOTSD_WriteMulti,
	.WriteMultiStop		= &BOOTSD_WriteMultiStop,
	.HDReadSector		= NULL,
	.HDWriteSector		= NULL,
	.HDClearSector		= NULL,
	.Ioctl			= &BOOTSD_Ioctl,
