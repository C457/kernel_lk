...
typedef enum
{
    ...
    NAND_IO_ERROR_FAIL_TO_SET_RRT				= 0xFC00000D,
    NAND_IO_ERROR_NOT_SUPPORT_NAND				= 0xFC00000E,
} NAND_IO_ERROR_T;
...
#define WINBOND_NAND_MAKER_ID					0xEF
...
#define A_ECC_6BIT								(ECC_TYPE_6BIT<<8)			// 6Bit MLC ECC
...
#define A_RR_H_16NM								0x00100000		// hynix read retry for 16nm
...
#define A_ECC_SPARE_6BIT						0x03000000		// 6bit MLC ECC for only Spare Area of 8Bit ECC Nand
...
#if 0
#if defined(_LINUX_)
	#if defined(TCC370X) || defined(TCC371X)
		#define NAND_IO_USE_MCU_ACCESS
	#elif defined(TCC801X) || defined(TCC892X)
		#define NAND_IO_USE_NDMA_ACCESS
	#elif defined(TCC8925S)
		#define NAND_IO_USE_DMA_ACCESS
	#elif defined(TCC893X) || defined(TCC889X) || defined(TCC896X) || defined(TCC897X)
		#define NAND_IO_USE_NDMA_ACCESS
...
#define NAND_IO_USE_MCU_ACCESS
	...
	#elif defined(TCC8925S) || defined(TCC893X) || defined(TCC889X) || defined(TCC896X) || defined(TCC897X)
	#define __USE_NAND_ISR__
	#elif defined(TCC88XX)
	//#define __USE_NAND_ISR__
	#endif	
...
#elif defined(TCC892X) || defined(TCC8925S) || defined(TCC893X) || defined(TCC889X) || defined(TCC897X)
...
#define	NAND_IO_HwCMD_PA							*(volatile unsigned long*)0x16600000		//( gNAND_IO_pHwND->CMD )
#define	NAND_IO_HwLADR_PA							*(volatile unsigned long*)0x16600004		//( gNAND_IO_pHwND->LADR )
#define	NAND_IO_HwDATA_PA							*(volatile unsigned long*)0x16600010		//( gNAND_IO_pHwND->WDATA.D32 )
#define	NAND_IO_HwLDATA_PA							*(volatile unsigned long*)0x16600020		//( gNAND_IO_pHwND->LDATA )
#define	NAND_IO_HwSADR_PA							*(volatile unsigned long*)0x16600008		//( gNAND_IO_pHwND->SADR )
...
#if defined(TCC88XX) || defined(TCC892X) || defined(TCC8925S) || defined(TCC801X) || defined(TCC893X) || defined(TCC370X) || defined(TCC371X) || defined(TCC800X) || defined(TCC889X) || defined(TCC896X) || defined(TCC897X)
...
#if defined(TCC93XX) || defined(TCC88XX) || defined(TCC892X) || defined(TCC8925S) || defined(TCC801X) || defined(TCC370X) || defined(TCC371X) || defined(TCC800X)
	unsigned char	CAHLD;
	unsigned char	CAPW;
	unsigned char	CASTP;
...
#define TNFTL_TAG_DWORD_SIZE					MTD_TAG_DWORD_SIZE
#define TNFTL_TAG_BYTE_SIZE						MTD_TAG_BYTE_SIZE
