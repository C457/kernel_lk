#ifndef _NAND_STRUCTURE_H
#define _NAND_STRUCTURE_H
...
#define HwCKC_BASE                              (0x14000000)

#define HwPIC_BASE                              (0x14100000)
#define HwVIC_BASE                              (0x14100200)

#define HwGPIO_BASE                             (0x14200000)

#define HwNFC_BASE                              (0x16600000)
#define HwECC_BASE                              (0x16600200)
#define HwECCBASE                               (0x16600208)

#define HwGDMA0_BASE                            (0x16030000)
#define HwGDMA1_BASE                            (0x16030100)
#define HwGDMA2_BASE                            (0x16030200)
