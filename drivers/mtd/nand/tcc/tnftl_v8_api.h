...
#define READRETRY_TABLE_SIZE_HYNIX_16NM			512

#define NULL_U32								0xFFFFFFFF
#define NULL_U16								0xFFFF

#define PRINT_FULL_DIE							0xEFFFFFFF
...
typedef enum
{
    ...
    TNFTL_ERROR_BL1_CRC_ERROR					= 0xFF00000F,
    TNFTL_ERROR_MEMINITCODE_CRC_ERROR			= 0xFF000010,
    TNFTL_ERROR_DEBUG_FULL						= 0xFF000011,
    TNFTL_ERROR_BLOCK_FULL						= 0xFF000012,
    TNFTL_ERROR_BAD_BLOCK						= 0xFF000013,
    TNFTL_ERROR_FAIL_TO_RECOVER_MAP_INFO		= 0xFF000014,
} TNFTL_ERROR_T;
...
typedef enum
{
    TNFTL_MARK_PMT_RECOVERY = 0,
    TNFTL_MARK_UPDATE_MAP_BLOCK,
    //TNFTL_MARK_SAVE_MAP_DATA
} TNFTL_MARK_TYPE_T;
...
*/
#define BOOT_ROM_WRITE_TYPE_START				(1<<0)
#define BOOT_ROM_WRITE_TYPE_MIRROR_IMAGE_START	(1<<1)

#define FW_WRITE_TYPE_FWDN							0
#define FW_WRITE_TYPE_UPDATE					(1<<0)
...
TNFTL_ERROR_T TNFTL_FW_Set_BL1TargetAddress( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiBL1TargetAddress );
...
TNFTL_ERROR_T TNFTL_FW_Write_BL1( TNFTL_OBJECT_T *pTnftlObj, unsigned char *pucBL1, unsigned int uiBL1Size, unsigned int uiBL1CRC, unsigned int uiBootRomWriteType );
unsigned int TNFTL_FW_Read_BL1( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiBL1Size, void *pvBuffer, unsigned int uiBootRomWriteType );
TNFTL_ERROR_T TNFTL_FW_Verify_BL1( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiBL1Size, unsigned int uiBL1CRC, unsigned int uiBootRomWriteType );
TNFTL_ERROR_T TNFTL_FW_Write_MemInitCode( TNFTL_OBJECT_T *pTnftlObj, unsigned char *pucMemInitCode, unsigned int uiMemInitCodeSize, unsigned int uiMemInitCodeCRC, unsigned int uiBootRomWriteType );
unsigned int TNFTL_FW_Read_MemInitCode( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiBL1Size, void *pvBuffer, unsigned int uiBootRomWriteType );
TNFTL_ERROR_T TNFTL_FW_Verify_MemInitCode( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiMemInitCodeSize, unsigned int uiMemInitCodeCRC, unsigned int uiBootRomWriteType );
...
TNFTL_ERROR_T TNFTL_FW_Write_BootCode( TNFTL_OBJECT_T *pTnftlObj, unsigned char *pucBuffer, unsigned int uiByteSize, unsigned int uiRomFileCRC, unsigned int eBootRomWriteType );
unsigned int TNFTL_FW_Read_BootCode(TNFTL_OBJECT_T *pTnftlObj, unsigned int uiByteSize, void *pvBuffer, unsigned int eBootRomWriteType );
TNFTL_ERROR_T TNFTL_FW_Verify_BootCode( TNFTL_OBJECT_T *pTnftlObj, unsigned int uiByteSize, unsigned int uiRomFileCRC, unsigned int eBootRomWriteType );
...
TNFTL_ERROR_T TNFTL_FW_Write_BootCode_For_TCC800X(TNFTL_OBJECT_T *pTnftlObj, unsigned char *pucBuffer, unsigned int uiByteSize, unsigned int eBootRomWriteType);
...
int TNFTL_ReadBlockType(TNFTL_OBJECT_T *pTnftlObj, unsigned int uiBlockAddress, void *pvTagBuffer);
int TNFTL_ReadSectorBlockType(TNFTL_OBJECT_T *pTnftlObj, unsigned int uiRWIndex, unsigned int uiSectorAddress, void *pvTagBuffer, unsigned int uiSectorCount);
int TNFTL_LBAtoPageAddress(TNFTL_OBJECT_T *pTnftlObj, unsigned int uiRWIndex, unsigned int uiSectorAddress);
#endif
