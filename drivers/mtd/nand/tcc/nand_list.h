...
static const unsigned char s_ucLowerPageTable_256PpB_MLC_Type3[128] =
{
	0x00,   
	0x01, 0x03, 0x05, 0x07, 0x09, 0x0B, 0x0D, 0x0F,
	0x11, 0x13, 0x15, 0x17, 0x19, 0x1B, 0x1D, 0x1F,
	...
	0xF1, 0xF3, 0xF5, 0xF7, 0xF9, 0xFB, 0xFD 
};
...
static const NAND_IO_FEATURE TOSHIBA_NAND_DevInfo[] =
{
	...
	{ {"TH58NVG2S0HTA"/*512MB*/, NULL, NULL},
	  {{0x98, 0xDC, 0x90, 0x26, 0x76, _ANY}},  2048,  0,  40,  64,  4096,  256,    2,  3,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_8BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
	...
	{ {"TH58NVG3S0HTA"/*1GB*/, NULL, NULL},
	  {{0x98, 0xD3, 0x91, 0x26, 0x76, _ANY}},  4096,  0,  80,  64,  4096,  256,    2,  3,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_8BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
...
static const NAND_IO_FEATURE HYNIX_NAND_DevInfo[] =
{
	...
	{ {"H27UBG8T2D"/*4GB*/, NULL, NULL}, //16nm
	  {{0xAD, 0xD7, 0x14, 0x9E, 0x34, 0x4A}},  2112,  0,  114, 256,  8192,  832,    2,  3,  16,   8,  6,  16,  16,  8,   6, (A_08BIT|A_ECC_40b_PER_1KB|A_RAND_IO|A_RR_H_16NM), (F_MP|F_CP|F_CR), s_ucLowerPageTable_256PpB_MLC_Type3 },
};
...
static const NAND_IO_FEATURE MICRON_NAND_DevInfo[] =
{
	...
	//*  1st,  2nd,  3rd,  4th,  5th,  6th,     BpD,DDP,BBpD, PpB,  Page,Spare,  Col,Row, tWC,tWP,tWH, tRC,tREA,tRP,tREH,  MediaType, UsableFunc, LSBPageTable
	//*=================================================================================================================================================================
	{ {"MT29F2G08ABAEA"/*256MB*/, NULL, NULL},
      {{0x2C, 0xDA, 0x90, 0x95, 0x06, _ANY}},  2048,  0,  40,  64,  2048,   64,    2,  3,  20, 10,  7,  20,  16, 10,   7, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
	{ {"MT29F4G08ABADA"/*512MB*/, NULL, NULL},
      {{0x2C, 0xDC, 0x90, 0x95, 0x56, _ANY}},  4096,  0,  80,  64,  2048,   64,    2,  3,  20, 10,  7,  20,  16, 10,   7, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
   	{ {"MT29F4G08ABAEA"/*512MB*/, NULL, NULL},
      {{0x2C, 0xDC, 0x90, 0xA6, 0x54, _ANY}},  2048,  0,  40,  64,  4096,  224,    2,  3,  20, 10,  7,  20,  16, 10,   7, (A_08BIT|A_ECC_8BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
    ...
    { {"MT29F16G08ABABA"/*2GB*/, NULL, NULL},
      {{0x2C, 0x48, 0x00, 0x26, 0x89, _ANY}},  4096,  0,  40, 128,  4096,  224,    2,  3,  25, 15, 10,  25,  20, 15,  10, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_MP|F_CR|F_EDO), NULL },
	...
	{ {"MT29F64G08CBABA"/*8GB*/, "MT29F128G08CFABA"/*16GB*/, NULL},
...
static const NAND_IO_FEATURE SPANSION_NAND_DevInfo[] =
{
	...
	{ {"S34ML02G1"/*256MB*/, NULL, NULL},
  	...
  	{ {"S34ML02G2"/*256MB*/, NULL, NULL},
	  {{0x01, 0xDA, 0x90, 0x95, 0x46, _ANY}},  2048,  0, 40, 64,  2048, 128,    2,  3,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_MP|F_CR), NULL },
  	...
  	{ {"S34ML08G1"/*1GB*/, NULL, NULL},
	  {{0x01, 0xD3, 0xD1, 0x95, 0x58, _ANY}},  4096, 18, 80, 64,  2048,  64,    2,  3,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_MP|F_CR), NULL },
};
...
const NAND_IO_FEATURE   MACRONIX_NAND_DevInfo[] =
{
   //*=======================================================================================================================================================
    ...
    { {"MX30LF2G28AB"/*256MB*/, NULL, NULL},
     {{0xC2, 0xDA, 0x90, 0x95, 0x07, _ANY}}, 2048,  0, 40,  64,   2048, 112,   2,   3,   20, 10,  7,  20, 16, 10,  7, (A_08BIT|A_ECC_8BIT|A_512B|A_ECC_SPARE_6BIT), (F_CP|F_MP|F_CR), NULL },
    { {"MX30LF4G28AB"/*512MB*/, NULL, NULL},
     {{0xC2, 0xDC, 0x90, 0x95, 0x57, _ANY}}, 4096,  0, 80,  64,   2048, 112,   2,   3,   20, 10,  7,  20, 16, 10,  7, (A_08BIT|A_ECC_8BIT|A_512B|A_ECC_SPARE_6BIT), (F_CP|F_MP|F_CR), NULL },
};
...
const NAND_IO_FEATURE   WINBOND_NAND_DevInfo[] =
{
	//*=================================================================================================================================================================
	//*[           DEVICE CODE               ][              SIZE               ][               Cycle                  ][                  ATTRIBUTE                  ]
	//*-----------------------------------------------------------------------------------------------------------------------------------------------------------------
	//*  1st,  2nd,  3rd,  4th,  5th,  6th,     BpD,DDP,BBpD, PpB,  Page,Spare,  Col,Row, tWC,tWP,tWH, tRC,tREA,tRP,tREH,  MediaType, UsableFunc, LSBPageTable
	//*=================================================================================================================================================================
	{ {"W29N01GV"/*128MB*/, NULL, NULL},
	  {{0xEF, 0xF1, 0x80, 0x95, 0x00, _ANY}},  1024,  0, 20,  64,   2048,  64,    2,  2,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_CR), NULL },
	{ {"W29N02GV"/*256MB*/, NULL, NULL},
	  {{0xEF, 0xDA, 0x90, 0x95, 0x04, _ANY}},  2048,  0, 40,  64,   2048,  64,    2,  3,  25, 12, 10,  25,  20, 12,  10, (A_08BIT|A_ECC_4BIT|A_512B), (F_CP|F_CR|F_MP), NULL },
};
