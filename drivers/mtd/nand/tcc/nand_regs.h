...
#elif defined(TCC93XX) || defined(TCC88XX) || defined(TCC892X) || defined(TCC801X) || defined(TCC8925S) || defined(TCC893X) || defined(TCC370X) || defined(TCC371X) || defined(TCC889X) || defined(TCC896X) || defined(TCC897X)
#define ECC_SHIFT_DATASIZE						16
#endif

#if defined(NFC_VER_200) // TCC88xx, TCC892x, TCC93xx
#define NDMA_ECC_ADDR_SHIFT						16
#elif defined(NFC_VER_300) // TCC8925S, TCC893X. TCC896X, TCC897X
